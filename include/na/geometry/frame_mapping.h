...
namespace na
{
	void make_basis(
		...
		Eigen::Ref<Eigen::Vector3d, Eigen::Unaligned, Eigen::InnerStride<Eigen::Dynamic>> D1,
		Eigen::Ref<Eigen::Vector3d, Eigen::Unaligned, Eigen::InnerStride<Eigen::Dynamic>> D2);
